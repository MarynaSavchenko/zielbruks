...
def generate_context_for_conflicts_report(past_conflicts, current_conflicts):
    ...
    context = {'removed_conflicts': removed_conflicts, 'removed_conflicts_number': len(removed_conflicts),
               'new_conflicts_number': len(new_conflicts), 'new_conflicts': new_conflicts}
    return context
